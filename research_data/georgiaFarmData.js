...
let cropInfo = [
    {
        ...
        whoKnew: "They're tastier and more nutritious when cultivated in the colder months",
        historicalFact: "They've been eaten for at lea st 2000 years, with evidence pointing to Ancient Greeks cultivating several varities.",
        medicinal: "Rich in folate, calcium, dietary fiber, and vitamins E, A, K, and C. Collard greens have been associated with cancer prevention, detox support, anti-inflammatory properties, heart health, and digestive support.",
...

    {
        ...
        history: ". Peaches were first planted in Georgia duringthe eighteenth century. The were shipped to the New York market for the first time between 1858 and 1860",
        ...
        art: "'A Still Life Painting of Peaches' by Pierre-Auguste Renoir",
        georgia: "Georgia ranks third, in the US, for peach production.",
        weirdFact: "In 2016, world production of peaches was 25 million tons, 58% of which was produced in China."
    },
...
let critterInfo = [
    {
        critter: "Hogs",
        latinName: `sus scrofa (domesticus) or sus indicus`,
        produce: "Although listed as unclean by some people-groups, Pork is the most widely consumed meat in the world. Bacon, sausage, pork chops, etc... are staples. Still others fit more esoteric ends: pork feet, chitterlings, and pig ears. Their sense of smell is superior to almost every animal as well. Pork skin is used for leather(football or drum heads), guts for violin strings, bones for china, oil for cutting/industrial lubricants, gelatin for marshmallows... the list is nearly endless. Tattoo artists use their skin for practice and doctors use their organs for preclinical study because they are so close to those of humans.",
        historicalFact: "Pigs, like humans, are omnivores. While mankind domesticated the beast, they are the only species known that can revert to a feral animal in under one generation. When left alone and uncared for, their hide regrows, teeth grow to tusks, and disposition becomes far less amenable.",
        ...
        history: "The domesticated pig is from the common Eurasian wild boar. Related to the peccary, Babirusa, and warthog, the pig first became its modern form ~500,000 year ago, and was domesticated ~7,000 B.C. They were first introduced to Europe in the 18th-19th centuries. There are many subspecies prized for various traits, like sense of smell, size, or taste. They have been used mostly for food, but also for leather, hunting (truffles, mostly), and even companionship. ",
        ...
        symbolism: "In Yin and Yang, the pig is the yin. In Asian cultures, they symbolize wealth. In Western cultures, they symbolize excess, laziness, awkwardness, and obesity.",
...

    {
        ...
        historicalFact: "Chickens were used solely for their eggs until about 150-200 years ago. They were unclean and difficult to eat without causing sickness, so they were only eaten by the wealthy who could afford to have them prepped correctly. In modern times, chicken is a staple and affordable food, especially in quick-service dining.",
        ...
        history: "Descended fom the Red Junglefowl, Chickens were first domesticated around 3,000 B.C. they helped keep pests (grubs, bugs, beetles, worms, etc...) out of owner's crops and fields, and their excrement was good for fertilizer.",
...
console.log(cropInfo[0].crop)
//include moonshine!? but where!?
